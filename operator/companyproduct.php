                                      ...
                                      <?php
                                       ...
                                       <?php
                                        ...
                                        if (isset($_POST['btnupdate'])){
                                            ...
                                            if ($koneksi){
                                             $update = "UPDATE data_produk SET perusahaan='$company'WHERE id_barang=$id";
                                             mysqli_query($koneksi,$update);
                                             echo "<script>setTimeout(\"location.href = 'companyproduct.php';\",1500);</script>";
                                    
                                            } elseif($koneksi->connect_error){
                                                echo 'Gagal';
                                                header('companyproduct.php');
                                            }
                                        }
